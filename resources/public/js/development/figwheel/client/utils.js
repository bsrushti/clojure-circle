...
return (new CustomEvent(event_name,(function (){var obj29099 = ({"detail":data});
return obj29099;
})()));
} else {
...
var f = (function (){var pred__29106 = cljs.core._EQ_;
var expr__29107 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29106.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29107))){
return ((function (pred__29106,expr__29107){
return (function (p1__29100_SHARP_){
return console.warn(p1__29100_SHARP_);
});
;})(pred__29106,expr__29107))
} else {
if(cljs.core.truth_(pred__29106.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29107))){
return ((function (pred__29106,expr__29107){
return (function (p1__29101_SHARP_){
return console.debug(p1__29101_SHARP_);
});
;})(pred__29106,expr__29107))
} else {
if(cljs.core.truth_(pred__29106.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29107))){
return ((function (pred__29106,expr__29107){
return (function (p1__29102_SHARP_){
return console.error(p1__29102_SHARP_);
});
;})(pred__29106,expr__29107))
} else {
return ((function (pred__29106,expr__29107){
return (function (p1__29103_SHARP_){
return console.log(p1__29103_SHARP_);
});
;})(pred__29106,expr__29107))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29110){
...
var eval_fn = cljs.core.get.call(null,map__29111__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29113_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29115,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1625902156283
